...
<body>
                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li><form action="courseServlet?email=${Semail}" method="POST">
                                            ...
                                            <li><a href="contact.html">Contact</a></li>
 	                                        <li>
 	                                           <form action="profileServlet?email=${Semail}" method="POST">
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Welcome, ${Sname}!</h1>
                                    <!-- breadcrumb Start-->
        ...
        <div class="services-area services-area2 section-padding15" style="padding:20px">
            <div class="container">
                            ...
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Advance Java Programming</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Aritfical Intelligence</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Discrete Mathematics</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Not stopping when it comes to learning.</p>
                                    </div>
                                </div>
                                <!-- social -->
